package com.couchbase.quarkus.extension.runtime;//package com.couchbase.quarkus.extension.deployment;
...
import static com.couchbase.client.core.deps.io.netty.handler.codec.http.HttpHeaderValues.X_GZIP;
...
@TargetClass(className = "com.couchbase.client.core.deps.io.netty.handler.ssl.JdkAlpnApplicationProtocolNegotiator")
...
/**
 * Hardcode com.couchbase.client.core.deps.io.netty.handler.ssl.OpenSsl as non-available
 */
...
@TargetClass(className = "com.couchbase.client.core.deps.io.netty.handler.ssl.JdkAlpnApplicationProtocolNegotiator$AlpnWrapper")
...
@TargetClass(className = "com.couchbase.client.core.deps.io.netty.util.concurrent.AbstractScheduledEventExecutor")
...
@TargetClass(className = "com.couchbase.client.core.deps.io.netty.handler.codec.http.HttpContentDecompressor")
...
@TargetClass(className = "com.couchbase.client.core.deps.io.netty.handler.codec.http2.DelegatingDecompressorFrameListener")
...
@TargetClass(className = "com.couchbase.client.core.deps.io.netty.handler.ssl.SslHandler")
...
@TargetClass(className = "com.couchbase.client.core.deps.io.netty.handler.ssl.PemReader")
 ...
 */
@TargetClass(className = "com.couchbase.client.core.deps.io.netty.handler.ssl.SslContext", onlyWith = IsBouncyNotThere.class)
